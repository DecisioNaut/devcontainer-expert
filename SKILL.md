...
For comprehensive documentation of all devcontainer.json properties with detailed examples, see **[references/JSON_SCHEMA_REFERENCE.md](references/JSON_SCHEMA_REFERENCE.md)**.
